...
namespace CarRentalManagement.Migrations
{
    ...
    [Migration("20230320064744_EF1DEA55-7819-4A96-AD8E-7432C7F131")]
    partial class EF1DEA5578194A96AD8E7432C7F131
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.CarLogbook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LogbookTypeEnum")
                        .IsRequired()
                        .IsUnicode(false)
                        .HasColumnType("varchar(max)");
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 20, 13, 47, 44, 495, DateTimeKind.Local).AddTicks(6314));
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.TrackNote", b =>
                {
                    ...
                    b.HasOne("CarRentalManagement.Models.Entities.CarLogbook", "CarLogbook")
                        .WithMany("TrackNotes")
                        .HasForeignKey("CarLogBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Car");

                    b.Navigation("CarLogbook");
                });
