...
namespace CarRentalManagement.Migrations
{
    ...
    [Migration("20230327025149_F4F7BA4E-A9EE-4C76-92C6-B0C95BFA1CCD")]
    partial class F4F7BA4EA9EE4C7692C6B0C95BFA1CCD
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.ContractTerminationMinutes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ContractTerminationMinutes");
                });
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 27, 9, 51, 49, 736, DateTimeKind.Local).AddTicks(3899));
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.ContractTerminationMinutes", b =>
                {
                    b.HasOne("CarRentalManagement.Models.Entities.Contract", "Contract")
                        .WithMany("ContractTerminationMinutes")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.Contract", b =>
                {
                    ...
                    b.Navigation("ContractTerminationMinutes");
