...
namespace CarRentalManagement.Migrations
{
    ...
    [Migration("20230323055606_1333B374-1CAB-4B94-AA3B-0EB4F359C233")]
    partial class _1333B3741CAB4B94AA3B0EB4F359C233
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.CheckInOutCar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CheckInOutAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                    ...
                    b.ToTable("CheckInOutCar", (string)null);
                });
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.EquipmentMaintenance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 12, 56, 6, 543, DateTimeKind.Local).AddTicks(143));
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.PaymentVoucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PaymentVoucherTypeEnum")
                        .IsRequired()
                        .IsUnicode(false)
                        .HasColumnType("varchar(max)");
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.RentalNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RentStatusEnum")
                        .IsRequired()
                        .IsUnicode(false)
                        .HasColumnType("varchar(max)");
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.VerifyProcessRent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CheckInOutCarId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VerifyImageThumb")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("CheckInOutCarId");

                    b.ToTable("VerifyProcessRent", (string)null);
                });
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.VerifyProcessRent", b =>
                {
                    b.HasOne("CarRentalManagement.Models.Entities.Car", null)
                        .WithMany("VerifyProcessRents")
                        .HasForeignKey("CarId");

                    b.HasOne("CarRentalManagement.Models.Entities.CheckInOutCar", "CheckInOutCar")
                        .WithMany("VerifyProcessRents")
                        .HasForeignKey("CheckInOutCarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CheckInOutCar");
                });
            ...
            modelBuilder.Entity("CarRentalManagement.Models.Entities.Car", b =>
                {
                    ...
                    b.Navigation("VerifyProcessRents");
                });
